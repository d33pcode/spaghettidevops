...
\\[t(n)=\begin{cases} 1 & \mbox{if } n\mbox{ is zero} \\\ t(n-1) + t(n-2) + t(n-3) + ... + t(2) + t(1) + 1 & \mbox{otherwise} \end{cases}\\]
Let's work out a few of the terms of the recurrence:
\\[t(1) = 1 \mathbin{,\ } t(2) = t(1) + 1 = 2 \mathbin{,\ } t(3) = t(2) + t(1) + 1 = 4 \mathbin{,\ } t(4) = t(3) + t(2) + t(1) + 1 = 8\\]
